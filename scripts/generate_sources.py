...
sources:
  - name: wwi_raw
    description: >
      Wide World Importers OLTP, frozen as a Parquet snapshot. Row counts, sizes and checksums
      live in data/snapshots/manifest.json, which is authoritative; they are not repeated here.
    meta:
