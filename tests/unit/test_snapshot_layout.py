...
@pytest.mark.parametrize(
    ...
    [
        ...
        # An offset is converted, not truncated -- and may move the date.
...
def test_bronze_prefix_has_no_bucket_and_no_slashes() -> None:
    prefix = bronze_prefix("20260818T125822Z")
...
def test_prefix_template_defaults_to_the_manifest_id() -> None:
    """With SNAPSHOT_ID unset, the build must read the snapshot the manifest names."""
